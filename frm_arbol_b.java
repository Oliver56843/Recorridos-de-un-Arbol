...
public void Recorridoorden(DefaultMutableTreeNode nodoIzquierdo){
        if(!nodoIzquierdo.getUserObject().toString().equals("I - NULL") && !nodoIzquierdo.getUserObject().toString().equals("D - NULL"))
        {
            ...
            Recorridoorden((DefaultMutableTreeNode) nodoIzquierdo.getLastChild());
            Recorridoorden((DefaultMutableTreeNode) nodoIzquierdo.getLastChild());
            Recorridoorden((DefaultMutableTreeNode) nodoIzquierdo.getLastChild());
            Recorridoorden((DefaultMutableTreeNode) nodoIzquierdo.getFirstChild());
        
        }
    }
    public void RecorridoPostorden(DefaultMutableTreeNode nodoPadre)
    {
        if(!nodoPadre.getUserObject().toString().equals("I - NULL") && !nodoPadre.getUserObject().toString().equals("D - NULL"))
        {
            strRecorrido += nodoPadre.getUserObject().toString().split("-")[1].trim() + " - ";
             RecorridoPostorden((DefaultMutableTreeNode) nodoPadre.getLastChild());
            RecorridoPostorden((DefaultMutableTreeNode) nodoPadre.getFirstChild());
            RecorridoPostorden((DefaultMutableTreeNode) nodoPadre.getLastChild());
            RecorridoPostorden((DefaultMutableTreeNode) nodoPadre.getFirstChild());
            RecorridoPostorden((DefaultMutableTreeNode) nodoPadre.getLastChild());
        }
